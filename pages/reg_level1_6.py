...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul 24 09:50:08 2023
...
if __name__ == "__main__":
    ...
    def display():
        ...
        def display_problem():
            ...
            display_new_line(r'''In the below Versus Fits plot on the right side, the spread of residuals is increasing with the increase in the Fitted Value. Which of the regression assumptions is violated in this example?''')
            image = Image.open('./pages/images/residual.png')
            st.image(image, caption='Residual plot')
        ...
        if problem_has_been_answered():
            ...
            v1 = multiple_choice(['Homoscedasticity','Multicollinearity', 'Nomality', 'Independence'], 'v1')
