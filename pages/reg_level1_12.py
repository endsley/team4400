...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul 24 16:57:49 2023
...
if __name__ == "__main__":
	...
	def display():
		...
		def display_problem():
			...
			display_new_line(r'''Which of the following of the coefficients is added in the penalty term to the loss function in Lasso Regression?''')
		...
		if problem_has_been_answered():
			...
			v1 = multiple_choice(['Absolute value of magnitude',
                         'Squared magnitude', 
                          
                         'Number of non-zero entries'], 'v1')
