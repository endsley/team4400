...
if __name__ == "__main__":
	...
	def display():
		...
		def display_problem():
			...
			display_new_line(r''' $$\begin{bmatrix} %d \\ %d \end{bmatrix} \otimes \begin{bmatrix} %d \\ %d \end{bmatrix} = \begin{bmatrix} a & b \\ c & d \end{bmatrix}$$, what is $$%s$$?''',(v1, v2, v3, v4, v5))
		# -------------------------------------------------------------------
