...
# -*- coding: utf-8 -*-
"""
Created on Tue Jul 25 07:21:40 2023
...
if __name__ == "__main__":
	...
	def display():
		...
		def display_problem():
			...
			display_new_line(r'''Which of the following statement is true: (1) In bagging trees, individual trees are independent of each other. (2) Bagging is the method for improving the performance by aggregating the results of weak learners?''')
