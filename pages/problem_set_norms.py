...
if __name__ == "__main__":
	page_properly_initialized(1, title='Norms', icon="⭐")
	if 'end_session' in st.session_state: del st.session_state['end_session']

	curFname, probList = get_all_problems(20, __file__)

	st.write('## Practice Questions for Norms')
	...
	pswd = input_field('password', type="password", key="mypswd")
