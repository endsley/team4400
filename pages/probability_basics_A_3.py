...
if __name__ == "__main__":
	...
	def display():
		...
		def display_problem():
			...
			display_new_line(r'''A probability distribution with multiple variables is called?''')
		...
		if problem_has_been_answered():
			...
			v1 = multiple_choice(['joint distribution', 'multi-distribution', 'poly-distribution'], 'v1')
