...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul 24 09:39:46 2023
...
if __name__ == "__main__":
	...
	def display():
		...
		def display_problem():
			...
			display_new_line(r'''A term used to describe the case when the predictors in a multiple regression model are correlated is called:''')
		...
		if problem_has_been_answered():
			...
			v1 = multiple_choice(['Multicollinearity', 
                         'Homoscedasticity', 
                         'Polynomial',
                         'Heteroscedasticity'], 'v1')
