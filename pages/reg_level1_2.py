...
if __name__ == "__main__":
	...
	def display():
		...
		def display_problem():
			...
			display_new_line(r'''Which of the following plots is best suited to test the linear relationship of continuous features and continuous target variables?''')
		...
		if problem_has_been_answered():
			...
			v1 = multiple_choice(['Scatter plot',
                         'Bar plot', 
                         'Boxplot'
                         ], 'v1')
