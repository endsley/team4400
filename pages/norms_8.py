...
if __name__ == "__main__":
	...
	def display():
		...
		def display_problem():
			...
			[v1, v2, v3, v4, v5, v6] = retrieve_display_variables()
			display_new_line(r'''What is the %s of the vector''',(v6))
			display_new_line(r'''
				$$ 
				\begin{bmatrix} %d \\ %d \\ %d \\ %d \\ %d \end{bmatrix}
				$$ 
				''',(v1, v2, v3, v4, v5))
		# -------------------------------------------------------------------
		...
		if problem_has_been_answered():
			...
			[v1, v2, v3, v4, v5] = getMultInts(5, -1, 1)
			v6 = getInt(0,7,'v6')
			...
			set_page_variables_for_display([v1, v2, v3, v4, v5, L[v6]])
			display_problem()

			# define the solution	
			a = np.array([v1, v2, v3, v4, v5])
			solution = vector_to_norm(a, L[v6])
