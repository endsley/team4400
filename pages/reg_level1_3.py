...
if __name__ == "__main__":
	...
	def display():
		...
		def display_problem():
			...
			display_new_line(r'''The Correlation Coefficient between the two variables was found to be -0.90, this means:''')
		...
		if problem_has_been_answered():
			...
			v1 = multiple_choice(['This is a strong correlation', 
                         'This is a weak correlation', 
                         'This is a strong positive correlation',
                         'This is a very weak negative correlation'], 'v1')
