...
if __name__ == "__main__":
	...
	def display():
		...
		def display_problem():
			...
			display_new_line(r'''Which of the following option would you consider to handle overfit due to high dimensionality''')
		...
		if problem_has_been_answered():
			...
			v1 = multiple_choice(['Dimension reduction and Feature Selection', 
                         'Feature Selection', 
                         'Dimension reduction'], 'v1')
